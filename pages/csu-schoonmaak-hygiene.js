...
export default function CSUSchoonmaakHygiene() {
  ...
  const company = {
    naam: "CSU",
    logo: "/logos/csu.png",
    categorie: "Schoonmaak & Hygiëne",
    categorieGradient: "linear-gradient(135deg, #06b6d4, #3b82f6)",
    ...
    specialismen: [
      {
        ...
        beschrijving: "Hoewel mensen de spil vormen van onze dienstverlening richting u, zijn ook technische innovatie omvattend in ons werk. Zo staan sensoren om te erop af aan ruimte wel of niet is gebruikt en hier ook, zoals we niet onnodig schoonmaken.\n\nDe toepassing van probiotica staat ons in staat om niet alleen te reinigen maar ook te beschermen. Een uniek voordeel dat de ook voorkomt dat de zichtgebruikte werkzij natuurlijk beschermende microfilm. Op die manier verbeteren we niet aan aanwezige schimmelsituatie en verminderen we welzijn van uw medewerkers.",
        status: "Operationele dienst"
      },
      {
        titel: "Glasbewassing & gevelreiniging",
        beschrijving: "Professionele glasbewassing en gevelreiniging voor alle soorten gebouwen. Wij zorgen voor een stralend schone uitstraling van uw pand, zowel aan de binnen- als buitenkant.",
        status: "Operationele dienst"
      },
      {
        titel: "Specialistisch onderhoud & Vloeronderhoud",
        beschrijving: "Vloeronderhoud en specialistisch onderhoud voor alle vloertypen. Van marmer tot vinyl, wij hebben de expertise om uw vloeren in perfecte staat te houden.",
        status: "Operationele dienst"
      }
    ],
