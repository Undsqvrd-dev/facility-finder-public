...
export default function CSUReceptieHospitality() {
  ...
  const company = {
    naam: "CSU",
    logo: "/logos/csu.png",
    categorie: "Receptie & Hospitality",
    categorieGradient: "linear-gradient(135deg, #f59e0b, #fb923c)",
    omschrijving: "Onze receptie- en hospitality diensten zorgen voor een warm welkom en professionele eerste indruk. Wij begrijpen dat de receptie het visitekaartje van uw organisatie is.",
    ...
    specialismen: [
      {
        titel: "Receptiediensten",
        beschrijving: "Professionele receptiediensten waarbij onze medewerkers zorgen voor een warm welkom, bezoekers registratie, telefoonbediening en administratieve ondersteuning. Wij zijn het eerste aanspreekpunt voor uw bezoekers en medewerkers.",
        status: "Operationele dienst"
      },
      {
        titel: "Hospitality & Gastvrij ontvangst",
        beschrijving: "Wij bieden complete hospitality diensten van koffie en thee arrangeren tot het verzorgen van vergaderingen en events. Onze medewerkers zorgen ervoor dat uw gasten zich welkom voelen.",
        status: "Operationele dienst"
      },
      {
        titel: "Bezoekersregistratie & toegangscontrole",
        beschrijving: "Moderne bezoekersregistratie systemen gecombineerd met vriendelijke en professionele medewerkers die zorgen voor een veilige en efficiënte toegangscontrole.",
        status: "Operationele dienst"
      }
    ],
    certificeringen: ["ISO 9001", "NEN 4400"],
    meerDiensten: [
      {
        ...
        <div style={{ padding: '16px 24px', background: 'white', borderBottom: '1px solid #e5e7eb' }}>
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            <Link href="/csu" style={{
              ...
              Terug naar Receptie & Hospitality
            </Link>
          </div>
        </div>
